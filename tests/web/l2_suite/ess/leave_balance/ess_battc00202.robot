*** Settings ***
Documentation       Test case to verify ESS user is able to review the leave balance and accruals
...
Test Tags    dev:bushra    config:ess    config:rws    config:holiday_hours_disabled    config:use_leave_hrs_in_ta:n    battc00202
...    bat_phase2    config:rta    om_hr


*** Test Cases ***
BATTC00202: Verify ESS user is able to review the leave balance and accruals and holiday hours disabled
    [Documentation]    Verify ESS user is able to review the leave balance and accruals before and after an approved day off request.
    ...
    ${day_off_data}    Get Day Off Data    template_name=paid_approved    start_date=1_6    end_date=1_6    holiday_hours={"6": "8"}
