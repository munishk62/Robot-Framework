*** Settings ***
Documentation       Test case to Verify Sort Preference On Labor Forecast
...
Test Tags    dev:rushikesh    action:read    battc00016    bat_phase1    config:rws    config:weekplan_and_schedule_gen    module:forecast


*** Test Cases ***
BATTC00016: Verify Sort preference in labor forecast
    [Documentation]    Test case to Verify Sort preference on labor forecast
    ...
    ${sort_preference_option_data}    Get System Value    LaborForecastSortOptions    STAFF_GROUP
    ...
    Set Sort Preference With Option On Labor Forecast Page On Web    ${sort_preference_option_data}
