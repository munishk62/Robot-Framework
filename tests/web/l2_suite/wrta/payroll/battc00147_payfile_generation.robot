*** Settings ***
Documentation       This test verifies the payfile is generated for the store in the new payroll employee group context
...
Test Tags           action:write    battc00147    dev:komal    config:rta    config:payroll_employee_group_enabled
...                 config:payfile_generation    payroll_execution    module:timekeeping


*** Test Cases ***
BATTC00147: Verify payfile is generated for the store (new payroll - employee group)
    [Documentation]    This test verifies the payfile is generated for the store in the new payroll employee group context
