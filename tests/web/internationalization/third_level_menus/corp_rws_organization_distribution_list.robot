*** Settings ***
Documentation       Verifies that the RWS Organization > Distribution List page loads and displays globalized texts correctly.
...
*** Test Cases ***
BATTC9999: Verify I18n For Organization Distribution List Page
    [Documentation]    Verifies that the RWS Organization > Distribution List >
    ...    Add Distribution List page loads and displays globalized texts correctly.
    Navigate To RWS Organization Distribution List Page On Web
    Open Add Distribution List Page On Web
