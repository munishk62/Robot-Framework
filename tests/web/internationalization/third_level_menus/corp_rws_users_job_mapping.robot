*** Settings ***
Documentation       Verifies that the RWS Users > Job Mapping page loads and displays globalized texts correctly.
...
Resource            resources/web/rws/users/job_mapping.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Job Mapping Page
    [Documentation]    Verifies that the RWS Users > Job Mapping >
    ...    Create Job Code page loads and displays globalized texts correctly.
    Navigate To RWS Users Job Mapping Page On Web
    Click On Create Job Code Button On Job Mapping Page On Web
