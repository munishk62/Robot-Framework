*** Settings ***
Documentation       Verifies that the RTA > Attendance > Management page loads and displays globalized texts correctly.
...
Resource            resources/web/rta/attendance/attendance_management.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Attendance Management Page
    [Documentation]    Verifies Attendance Management page loads for the globalized texts on the page.
    Navigate To RTA Attendance Management Page On Web
    Click On Add Attendance Button On Attendance Management Page On Web
