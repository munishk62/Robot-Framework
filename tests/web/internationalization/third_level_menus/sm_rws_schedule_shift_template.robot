*** Settings ***
Documentation       Verifies that the Store RWS Schedule > Shift Template page loads and displays globalized texts correctly.
...
Resource            resources/web/rws/schedule/shift_template.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For SM RWS Schedule Shift Template Add Shift Template Page
    [Documentation]    Verifies that the Store RWS Schedule > Shift Template >
    ...    Add Shift Template page loads and displays globalized texts correctly.
    Navigate To RWS Shift Template Page On Web
    Click On Add Shift Template Button In Shift Template Page On Web
