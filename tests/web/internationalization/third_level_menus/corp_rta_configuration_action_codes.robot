*** Settings ***
Documentation       Verifies that the RTA > Configuration > Add New Action Codes page loads and displays globalized texts correctly.
...
Resource            resources/web/rta/configuration/action_codes.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Configuration Add New Action Codes Page
    [Documentation]    Verifies Configuration Add New Action Codes page loads for the globalized texts on the page.
    Navigate To RTA Configuration Action Codes Page On Web
    Click On Add Action Code Button On Action Codes Page On Web
