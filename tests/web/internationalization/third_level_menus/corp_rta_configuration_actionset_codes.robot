*** Settings ***
Documentation       Verifies that the RTA > Configuration > Add New Actionset Codes page loads and displays globalized texts correctly.
...
Resource            resources/web/rta/configuration/actionset_codes.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Configuration Add New Actionset Codes Page
    [Documentation]    Verifies Configuration Add New Actionset Codes page loads for the globalized texts on the page.
    Navigate To RTA Configuration Actionset Codes Page On Web
    Click On Add Actionset Code Button On Actionset Codes Page On Web
