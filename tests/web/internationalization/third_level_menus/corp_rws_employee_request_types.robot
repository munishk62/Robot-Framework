*** Settings ***
Documentation       Verifies that the RWS Employee > Request Types page loads and displays globalized texts correctly.
...
Resource            resources/web/rws/employee/request_types.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Add Request Type Page
    [Documentation]    Verifies that the RWS Employee > Request Types page loads and displays globalized texts correctly.
    Navigate To RWS Request Types Page On Web
    Click On Add Request Type Button On Request Types Page On Web
