*** Settings ***
Documentation       Verifies that the RWS Schedule > Net Rules page loads and displays globalized texts correctly.
...
Resource            resources/web/rws/schedule/net_rules.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For RWS Schedule Net Rules Add Net Rule Page
    [Documentation]    Verifies that the RWS Schedule > Net Rules >
    ...    Add Net Rule page loads and displays globalized texts correctly.
    Navigate To RWS Net Rules Page On Web
    Click On Add Net Rule Button In Net Rules Page On Web
