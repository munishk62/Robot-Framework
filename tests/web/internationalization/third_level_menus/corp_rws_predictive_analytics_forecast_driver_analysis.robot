*** Settings ***
Documentation       Verifies that the RWS Predictive Analytics > Forecast Driver Analysis page loads and displays globalized texts correctly.
...
Resource            resources/web/rws/predictive_analytics/forecast_driver_analysis.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Forecast Driver Analysis Markers And Statistics Page
    [Documentation]    Verifies that the RWS Predictive Analytics > Forecast Driver Analysis page loads and displays globalized texts correctly.
    Navigate To RWS Forecast Driver Analysis Page On Web
    Expand Forecast Driver Analysis Markers Tab On Web
    Start Visible Text Inventory
    Expand Forecast Driver Analysis Statistics Tab On Web
