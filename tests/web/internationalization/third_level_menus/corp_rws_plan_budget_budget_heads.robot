*** Settings ***
Documentation       Verifies that the RWS Plan Budget > Budget Heads page loads and displays globalized texts correctly.
...
Resource            resources/web/rws/plan_budget/budget_heads.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Plan Budget Add Budget Heads Page
    [Documentation]    Verifies that the RWS Plan Budget > Budget Heads >
    ...    Add Budget Head page loads and displays globalized texts correctly.
    Navigate To RWS Budget Heads Page On Web
    Click On Add Budget Head Button In Budget Heads Page On Web
