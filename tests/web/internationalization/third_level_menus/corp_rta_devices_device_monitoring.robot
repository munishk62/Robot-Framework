*** Settings ***
Documentation       Verifies that the RTA > Devices > Device Monitoring page loads and displays globalized texts correctly.
...
Resource            resources/web/rta/devices/device_monitoring.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Devices Add Device Monitoring Page
    [Documentation]    Verifies Device Monitoring page loads for the globalized texts on the page.
    Navigate To RTA Devices Device Monitoring Page On Web
    Click On Add Device Monitoring Button On Device Monitoring Page On Web
