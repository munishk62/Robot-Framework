*** Settings ***
Documentation       Verifies that the RWS Predictive Analytics > Seasonality Index page loads and displays globalized texts correctly.
...
Resource            resources/web/rws/predictive_analytics/seasonality_index.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Seasonality Index Initialize Page
    [Documentation]    Verifies that the RWS Predictive Analytics > Seasonality Index page loads and displays globalized texts correctly.
    Navigate To RWS Seasonality Index Page On Web
    Click On Initialize Mode Button On Seasonality Index Page On Web
