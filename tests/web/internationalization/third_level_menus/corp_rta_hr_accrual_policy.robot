*** Settings ***
Documentation       Verifies that the RTA > HR > Accrual Policy page loads and displays globalized texts correctly.
...
Resource            resources/web/rta/hr/accrual_policy.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For HR Add Accrual Policy Page
    [Documentation]    Verifies HR Add Accrual Policy page loads for the globalized texts on the page.
    Navigate To RTA HR Accrual Policy Page On Web
    Click On Add Accrual Policy Button On Accrual Policy Page On Web
