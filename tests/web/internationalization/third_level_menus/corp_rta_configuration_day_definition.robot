*** Settings ***
Documentation       Verifies that the RTA > Configuration > Add New Day Definition page loads and displays globalized texts correctly.
...
Resource            resources/web/rta/configuration/day_definition.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Configuration Add New Day Definition Page
    [Documentation]    Verifies Configuration Add New Day Definition page loads for the globalized texts on the page.
    Navigate To RTA Configuration Day Definition Page On Web
    Click On Add Day Definition Button On Day Definition Page On Web
