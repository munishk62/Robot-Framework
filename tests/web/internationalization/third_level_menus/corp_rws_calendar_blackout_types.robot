*** Settings ***
Documentation       Verifies that the RWS Calendar > Blackout Types page loads and displays globalized texts correctly.
...
Resource            resources/web/rws/calendar/blackout_types.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Blackout Types Page
    [Documentation]    Verifies that the RWS Calendar > Blackout Types >
    ...    Add Holiday Type page loads and displays globalized texts correctly.
    Navigate To RWS Blackout Types Page On Web
    Click On Add Holiday Type Button On Blackout Types Page On Web
