*** Settings ***
Documentation       Verifies that the RWS Predictive Analytics > Driver Setup page loads and displays globalized texts correctly.
...
Resource            resources/web/rws/predictive_analytics/driver_setup.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Add Driver Setup Page
    [Documentation]    Verifies that the RWS Predictive Analytics > Driver Setup page loads and displays globalized texts correctly.
    Navigate To RWS Driver Setup Page On Web
    Click On Add Driver Button On Driver Setup Page On Web
