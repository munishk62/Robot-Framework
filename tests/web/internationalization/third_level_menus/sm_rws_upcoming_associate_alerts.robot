*** Settings ***
Documentation       Verifies that the Store RWS Upcoming > Associate Alerts page loads and displays globalized texts correctly.
...
Resource            resources/web/rws/upcoming/associate_alerts.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For SM RWS Upcoming Associate Alerts Page
    [Documentation]    Verifies that the Store RWS Upcoming > Associate Alerts page loads and displays globalized texts correctly.
    Navigate To RWS Associate Alerts Page On Web
    Click On First Visible Request On Associate Alerts Page On Web
    Start Visible Text Inventory
    Click On Request Details All Tab On Associate Alerts Page On Web
