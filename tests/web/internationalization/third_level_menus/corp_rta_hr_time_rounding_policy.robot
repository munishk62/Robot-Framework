*** Settings ***
Documentation       Verifies that the RTA > HR > Time Rounding Policy page loads and displays globalized texts correctly.
...
Resource            resources/web/rta/hr/time_rounding_policy.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For HR Add Time Rounding Policy Page
    [Documentation]    Verifies HR Add Time Rounding Policy page loads for the globalized texts on the page.
    Navigate To RTA HR Time Rounding Policy Page On Web
    Click On Add Time Rounding Policy Button On Time Rounding Policy Page On Web
