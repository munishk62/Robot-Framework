*** Settings ***
Documentation       Verifies that the RWS Users > User Profile page loads and displays globalized texts correctly.
...
*** Test Cases ***
BATTC9999: Verify I18n For User Profile Page
    [Documentation]    Verifies that the RWS Users > User Profile >
    ...    Add User Profile page loads and displays globalized texts correctly.
