*** Settings ***
Documentation       Verifies that the PSA > Advanced Settings > Worker Status page loads and displays globalized texts correctly.
...
Resource            resources/web/psa/advanced_settings/worker_status.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For PSA Advanced Settings Worker Status Add Worker Page
    [Documentation]    Verifies that the PSA > Advanced Settings > Worker Status page loads and displays globalized texts correctly.
    Navigate To PSA Worker Status Page On Web
    Click On Add Worker Button On Worker Status Page On Web
