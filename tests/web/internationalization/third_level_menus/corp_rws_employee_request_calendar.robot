*** Settings ***
Documentation       Verifies that the RWS Employee > Request Calendar page loads and displays globalized texts correctly.
...
*** Test Cases ***
BATTC9999: Verify I18n For Request Calendar Add Dayoff Or Timeoff Page
    [Documentation]    Verifies that the RWS Employee > Request Calendar > Add Dayoff or Timeoff page loads
...
BATTC9998: Verify I18n For Request Calendar Add Availability Page
    [Documentation]    Verifies that the RWS Employee > Request Calendar > Add Availability page loads
    ...    and displays globalized texts correctly.
    Navigate To RWS Employee Request Calendar Page On Web
