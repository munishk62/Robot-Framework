*** Settings ***
Documentation       Verifies that the RWS Schedule > Skill Coverage page loads and displays globalized texts correctly.
...
Resource            resources/web/rws/schedule/skill_coverage.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For RWS Schedule Skill Coverage Add Skill Coverage Page
    [Documentation]    Verifies that the RWS Schedule > Skill Coverage >
    ...    Add Skill Coverage page loads and displays globalized texts correctly.
    Navigate To RWS Skill Coverage Page On Web
    Click On Add Skill Coverage Button In Skill Coverage Page On Web
