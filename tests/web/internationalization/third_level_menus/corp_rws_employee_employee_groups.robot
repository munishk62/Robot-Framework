*** Settings ***
Documentation       Verifies that the RWS Employee > Employee Groups page loads and displays globalized texts correctly.
...
Resource            resources/web/rws/employee/employee_groups.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Add Employee Group Page
    [Documentation]    Verifies that the RWS Employee > Employee Groups page loads and displays globalized texts correctly.
    Navigate To RWS Employee Groups Page On Web
    Click On Add Employee Group Button On Employee Groups Page On Web
