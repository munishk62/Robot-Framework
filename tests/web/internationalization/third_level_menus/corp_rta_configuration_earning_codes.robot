*** Settings ***
Documentation       Verifies that the RTA > Configuration > Earning Codes > Add New Earning Code page loads and displays globalized texts correctly.
...
Resource            resources/web/rta/configuration/earning_codes.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Configuration Add New Earning Codes Page
    [Documentation]    Verifies Configuration Add New Earning Codes page loads for the globalized texts on the page.
    Navigate To RTA Configuration Earning Codes Page On Web
    Click On Add Earning Code Button On Earning Codes Page On Web
