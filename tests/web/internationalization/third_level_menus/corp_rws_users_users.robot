*** Settings ***
Documentation       Verifies that the RWS Users > Users page loads and displays globalized texts correctly.
...
*** Test Cases ***
BATTC9999: Verify I18n For Users Page
    [Documentation]    Verifies that the RWS Users > Users >
    ...    Add User page loads and displays globalized texts correctly.
