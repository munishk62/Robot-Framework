*** Settings ***
Documentation       Verifies that the RTA > HR > Policies page loads and displays globalized texts correctly.
...
Resource            resources/web/rta/hr/policies.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For HR Add Policies Page
    [Documentation]    Verifies HR Add Policies page loads for the globalized texts on the page.
