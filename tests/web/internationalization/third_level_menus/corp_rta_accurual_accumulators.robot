*** Settings ***
Documentation       Verifies that the RTA > HR > Accrual Accumulators page loads and displays globalized texts correctly.
...
Resource            resources/web/rta/hr/accrual_accumulators.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For HR Accrual Accumulators Page
    [Documentation]    Verifies HR Accrual Accumulators page loads for the globalized texts on the page.
    Navigate To RTA HR Accrual Accumulators Page On Web
    Click On Add Accrual Accumulators Button On Accrual Accumulators Page On Web
