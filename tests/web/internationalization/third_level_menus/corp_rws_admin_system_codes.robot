*** Settings ***
Documentation       Verifies that the RWS Admin > System Codes page loads and displays globalized texts correctly.
...
Resource            resources/web/rws/admin/system_codes.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For RWS Admin System Codes Add System Code Page
    [Documentation]    Verifies that the RWS Admin > System Codes >
    ...    Add System Code page loads and displays globalized texts correctly.
    Navigate To RWS System Codes Page On Web
    Click On Add System Code Button In System Codes Page On Web
