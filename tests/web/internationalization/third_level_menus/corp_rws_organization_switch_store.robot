*** Settings ***
Documentation       Verifies that the RWS Organization > Switch Store page loads and displays globalized texts correctly.
...
Resource            resources/web/organization/switch_store.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Organization Switch Store Page
    [Documentation]    Verifies that the RWS Organization > Switch Store page
    ...    loads and displays globalized texts correctly.
