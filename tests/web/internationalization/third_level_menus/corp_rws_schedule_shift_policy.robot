*** Settings ***
Documentation       Verifies that the RWS Schedule > Shift Policy page loads and displays globalized texts correctly.
...
Resource            resources/web/rws/schedule/shift_policy.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For RWS Schedule Shift Policy Add Shift Policy Page
    [Documentation]    Verifies that the RWS Schedule > Shift Policy >
    ...    Add Shift Policy page loads and displays globalized texts correctly.
    Navigate To RWS Shift Policy Page On Web
    Click On Add Shift Policy Button In Shift Policy Page On Web
