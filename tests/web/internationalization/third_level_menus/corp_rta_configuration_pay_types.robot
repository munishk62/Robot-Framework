*** Settings ***
Documentation       Verifies that the RTA > Configuration > Add New Pay Types page loads and displays globalized texts correctly.
...
Resource            resources/web/rta/configuration/pay_types.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Configuration Add New Pay Types Page
    [Documentation]    Verifies Configuration Add New Pay Types page loads for the globalized texts on the page.
    Navigate To RTA Configuration Pay Types Page On Web
    Click On Add Pay Type Button On Pay Types Page On Web
