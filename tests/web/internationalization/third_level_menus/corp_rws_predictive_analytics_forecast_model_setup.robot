*** Settings ***
Documentation       Verifies that the RWS Predictive Analytics > Forecast Model Setup page loads and displays globalized texts correctly.
...
Resource            resources/web/rws/predictive_analytics/forecast_model_setup.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Add Driver Model Page
    [Documentation]    Verifies that the RWS Predictive Analytics > Forecast Model Setup page loads and displays globalized texts correctly.
    Navigate To RWS Forecast Model Setup Page On Web
    Click On Add Driver Model Button On Forecast Model Setup Page On Web
