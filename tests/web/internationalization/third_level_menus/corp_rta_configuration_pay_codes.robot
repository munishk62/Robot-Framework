*** Settings ***
Documentation       Verifies that the RTA > Configuration > Pay Codes > Add New Pay Code page loads and displays globalized texts correctly.
...
Resource            resources/web/rta/configuration/pay_codes.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Configuration Add New Pay Codes Page
    [Documentation]    Verifies Configuration Add New Pay Codes page loads for the globalized texts on the page.
    Navigate To RTA Configuration Pay Codes Page On Web
    Click On Add Pay Code Button On Pay Codes Page On Web
