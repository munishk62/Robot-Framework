*** Settings ***
Documentation       Verifies that the RWS Driver Forecast > Driver Models page loads and displays globalized texts correctly.
...
Resource            resources/web/rws/driver_forecast/driver_models.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Driver Models Page
    [Documentation]    Verifies that the RWS Driver Forecast > Driver Models >
    ...    Add Forecast Model page loads and displays globalized texts correctly.
    Navigate To RWS Driver Models Page On Web
    Click On Add Forecast Model Button In Driver Models Page On Web
