*** Settings ***
Documentation       Verifies that the RTA > Configuration > Add New Accrual Type page loads and displays globalized texts correctly.
...
Resource            resources/web/rta/configuration/accrual_types.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Configuration Add New Accrual Types Page
    [Documentation]    Verifies Configuration Add New Accrual Types page loads for the globalized texts on the page.
    Navigate To RTA Configuration Accrual Types Page On Web
    Click On Add Accrual Type Button On Accrual Types Page On Web
