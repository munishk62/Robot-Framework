*** Settings ***
Documentation       Verifies that the RTA > Devices > Operations Policy page loads and displays globalized texts correctly.
...
Resource            resources/web/rta/devices/operations_policy.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Devices Add Operations Policy Page
    [Documentation]    Verifies Devices Operations Policy page loads for the globalized texts on the page.
    Navigate To RTA Devices Operations Policy Page On Web
    Click On Add Device Group Button On Operations Policy Page On Web
