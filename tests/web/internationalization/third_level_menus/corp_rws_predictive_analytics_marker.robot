*** Settings ***
Documentation       Verifies that the RWS Predictive Analytics > Marker page loads and displays globalized texts correctly.
...
Resource            resources/web/rws/predictive_analytics/marker.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Add Marker Page
    [Documentation]    Verifies that the RWS Predictive Analytics > Marker page loads and displays globalized texts correctly.
    Navigate To RWS Marker Page On Web
    Click On Add Marker Button On Marker Page On Web
