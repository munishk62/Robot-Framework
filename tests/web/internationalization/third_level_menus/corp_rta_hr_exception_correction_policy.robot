*** Settings ***
Documentation       Verifies that the RTA > HR > Exception Correction Policy page loads and displays globalized texts correctly.
...
Resource            resources/web/rta/hr/exception_correction_policy.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For HR Add Exception Correction Policy Page
    [Documentation]    Verifies HR Add Exception Correction Policy page loads for the globalized texts on the page.
    Navigate To RTA HR Exception Correction Policy Page On Web
    Click On Add Exception Correction Policy Button On Exception Correction Policy Page On Web
