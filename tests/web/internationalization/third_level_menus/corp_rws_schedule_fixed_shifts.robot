*** Settings ***
Documentation       Verifies that the RWS Schedule > Fixed Shifts page loads and displays globalized texts correctly.
...
*** Test Cases ***
BATTC9999: Verify I18n For RWS Schedule Fixed Shifts Add Template Page
    [Documentation]    Verifies that the RWS Schedule > Fixed Shifts >
    ...    Add Template page loads and displays globalized texts correctly.
