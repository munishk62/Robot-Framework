*** Settings ***
Documentation       Verifies that the RTA > Operations > Clock Supervisors page loads and displays globalized texts correctly.
...
Resource            resources/web/rta/operations/clock_supervisors.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Add Clock Supervisors Page
    [Documentation]    Verifies Add Clock Supervisors page loads for the globalized texts on the page.
    Navigate To RTA Operations Clock Supervisors Page On Web
    Click On Add Supervisor Button On Clock Supervisors Page On Web
