*** Settings ***
Documentation       Verifies that the RTA > Devices > Add New Device page loads and displays globalized texts correctly.
...
Resource            resources/web/rta/devices/device.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Devices Add New Device Page
    [Documentation]    Verifies Devices Add New Device page loads for the globalized texts on the page.
    Navigate To RTA Devices Device Page On Web
    Click On Add Device Button On Device Page On Web
