*** Settings ***
Documentation       Verifies that the RWS Employee > Reporting Hierarchy page loads and displays globalized texts correctly.
...
Resource            resources/web/rws/employee/reporting_hierarchy.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Add Reporting Hierarchy Page
    [Documentation]    Verifies that the RWS Employee > Reporting Hierarchy page loads and displays globalized texts correctly.
    Navigate To RWS Reporting Hierarchy Page On Web
    Click On Add Reporting Hierarchy Button On Reporting Hierarchy Page On Web
    Start Visible Text Inventory
    Click On Next Button On Add Reporting Hierarchy Details Tab Page On Web
