*** Settings ***
Documentation       Verifies that the RWS Labor Forecast > Activities page loads and displays globalized texts correctly.
...
Resource            resources/web/rws/labor_forecast/activities.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Activities Add Task Page
    [Documentation]    Verifies that the RWS Labor Forecast > Activities >
    ...    Add New Activity page loads and displays globalized texts correctly.
    Navigate To RWS Activities Page On Web
    Click On Add Task Button In Activities Page On Web
