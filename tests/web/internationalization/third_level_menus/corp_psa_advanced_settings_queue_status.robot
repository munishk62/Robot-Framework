*** Settings ***
Documentation       Verifies that the PSA > Advanced Settings > Queue Status page loads and displays globalized texts correctly.
...
Resource            resources/web/psa/advanced_settings/queue_status.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For PSA Advanced Settings Queue Status Add Queue Page
    [Documentation]    Verifies that the PSA > Advanced Settings > Queue Status page loads and displays globalized texts correctly.
    Navigate To PSA Queue Status Page On Web
    Click On Add Queue Button On Queue Status Page On Web
