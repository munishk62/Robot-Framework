*** Settings ***
Documentation       Verifies that the RTA > HR > Agreement page loads and displays globalized texts correctly.
...
Resource            resources/web/rta/hr/agreement.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For HR Add Agreement Page
    [Documentation]    Verifies HR Add Agreement page loads for the globalized texts on the page.
    Navigate To RTA HR Agreement Page On Web
    Click On Add Agreement Button On Agreement Page On Web
