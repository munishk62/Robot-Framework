*** Settings ***
Documentation       Verifies that the RWS Employee > Criteria Configuration page loads and displays globalized texts correctly.
...
Resource            resources/web/rws/employee/criteria_configuration.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Add Criteria Configuration Page
    [Documentation]    Verifies that the RWS Employee > Criteria Configuration page loads and displays globalized texts correctly.
    Navigate To RWS Criteria Configuration Page On Web
    Click On Add Criteria Configuration Button On Criteria Configuration Page On Web
