*** Settings ***
Documentation       Verifies that the RTA > Configuration > Add New Job Code form loads and displays globalized texts correctly.
...
Resource            resources/web/rta/configuration/job_codes.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Configuration Add New Job Codes Page
    [Documentation]    Verifies Configuration Add New Job Codes page loads for the globalized texts on the page.
    Navigate To RTA Configuration Job Codes Page On Web
    Click On Add Job Code Button On Job Codes Page On Web
