*** Settings ***
Documentation       Verifies that the RWS Driver Forecast > Drivers page loads and displays globalized texts correctly.
...
*** Test Cases ***
BATTC9999: Verify I18n For Drivers Page
    [Documentation]    Verifies that the RWS Driver Forecast > Drivers >
    ...    Add Driver page loads and displays globalized texts correctly.
