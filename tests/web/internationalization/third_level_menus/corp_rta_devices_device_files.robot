*** Settings ***
Documentation       Verifies that the RTA > Devices > Device Files page loads and displays globalized texts correctly.
...
Resource            resources/web/rta/devices/device_files.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Devices Add Device Files Page
    [Documentation]    Verifies Devices Device Files page loads for the globalized texts on the page.
    Navigate To RTA Devices Device Files Page On Web
    Click On Add Device Files Button On Device Files Page On Web
