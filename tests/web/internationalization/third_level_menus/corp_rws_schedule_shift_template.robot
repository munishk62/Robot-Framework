*** Settings ***
Documentation       Verifies that the RWS Schedule > Shift Template page loads and displays globalized texts correctly.
...
*** Test Cases ***
BATTC9999: Verify I18n For RWS Schedule Shift Template Add Shift Template Page
    [Documentation]    Verifies that the RWS Schedule > Shift Template >
