*** Settings ***
Documentation       Verifies that the RWS Predictive Analytics > Rounding and Smoothing page loads and displays globalized texts correctly.
...
Resource            resources/web/rws/predictive_analytics/rounding_and_smoothing.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Add RAS Model Page
    [Documentation]    Verifies that the RWS Predictive Analytics > Rounding and Smoothing page loads and displays globalized texts correctly.
    Navigate To RWS Rounding And Smoothing Page On Web
    Click On Add RAS Model Button On Rounding And Smoothing Page On Web
