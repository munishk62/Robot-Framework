*** Settings ***
Documentation       Verifies that the RTA > HR > Pay Policy page loads and displays globalized texts correctly.
...
Resource            resources/web/rta/hr/pay_policy.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For HR Add Pay Policy Page
    [Documentation]    Verifies HR Add Pay Policy page loads for the globalized texts on the page.
