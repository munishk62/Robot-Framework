*** Settings ***
Documentation       Verifies that the RTA > Operations > Add New Manager Functions page loads and displays globalized texts correctly.
...
Resource            resources/web/rta/operations/manager_functions.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For Operations Add New Manager Functions Page
    [Documentation]    Verifies Operations Add New Manager Functions page loads for the globalized texts on the page.
    Navigate To RTA Operations Manager Functions Page On Web
    Click On Add Manager Button On Manager Functions Page On Web
