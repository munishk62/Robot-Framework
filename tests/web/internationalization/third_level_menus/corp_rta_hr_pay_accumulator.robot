*** Settings ***
Documentation       Verifies that the RTA > HR > Pay Accumulator page loads and displays globalized texts correctly.
...
Resource            resources/web/rta/hr/pay_accumulator.resource
...
*** Test Cases ***
BATTC9999: Verify I18n For HR Add Pay Accumulator Page
    [Documentation]    Verifies HR Add Pay Accumulator page loads for the globalized texts on the page.
    Navigate To RTA HR Pay Accumulator Page On Web
    Click On Add Pay Accumulator Button On Pay Accumulator Page On Web
