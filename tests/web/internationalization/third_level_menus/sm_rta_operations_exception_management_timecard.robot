*** Settings ***
Documentation       Verifies that the RTA > Operations > Exception Management > Timecard page loads and displays globalized texts correctly.
...
*** Test Cases ***
BATTC9999: Verify I18n For Exception Management Timecard Page
    [Documentation]    Verifies Exception Management Timecard page loads for the globalized texts on the page.
