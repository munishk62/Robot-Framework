*** Settings ***
Documentation       SITTC60028 - Shift Trade - Raise Swap request (different day-1:1) from ESS, respond from another ESS and approve from SM.
...                 ESS7_STORE12 raises swap request on Day 3 to swap with ESS6_STORE12's shift on Day 6.
...
Test Tags           dev:kishan    sittc60028    schedule_dependent    config:ess    config:rta    config:weekplan_and_schedule_gen    config:swap_shift_enabled    mobile    sit    sit_b0    sit_v1    sit_r22
...    config:mobile_shift_enabled    config:mobile_sm_enabled


*** Test Cases ***
SITTC60028: Shift Trade - Raise Swap request (different day-1:1) from ESS, respond from another ESS and approve from SM
    [Documentation]    Verify approval of swap 1:1 shift response in mobile (different day).
    ...    ESS7_STORE12 raises a swap request on Day 3 to swap with ESS6_STORE12's shift on Day 6.
    ...
    ${shift_trade_data}    Get Individual Swap Shift Data    planning_week_date=3_0    week_trade_day=3_1    week_swap_day=3_5
    ...    shift_start_time=06:00    shift_end_time=13:00
    ...    swap_request_notes=Automation Notes for Different Day Swap Approve

    # Step 1: ESS7_STORE12 raises individual swap request on Day 3 targeting ESS6_STORE12's Day 6
    Open Mobile ESS App    sittc60028
    ...
    ...    ${shift_trade_data}[week_swap_day]    ${shift_trade_data}[swap_shift_start_time]    ${shift_trade_data}[swap_shift_end_time]
    ...
    Close Mobile Application    sittc60028_ess_raise_swap
    ...
    Select MyRequest Tab On Mobile ESS
    Select Pending Status In MyRequest Filter On Mobile ESS    ${shift_trade_data}[planning_week_date]
    ...    ${shift_trade_data}[week_swap_day]    28
    Select Shift From My Requests On Mobile ESS    ${shift_trade_data}[week_trade_day]    ${shift_trade_data}[shift_start_time]
    ...    ${shift_trade_data}[shift_end_time]
    ...
    Close Mobile Application    sittc60028_ess_accept_swap

    # Step 3: SM1_STORE12 approves the swap shift response
    Open SM Native Application On Mobile Phone    sittc60028
    ...
    Close Mobile Application    sittc60028_sm_approve_swap
    ...
    ...    ${shift_trade_data}[shift_end_time]    ${shift_trade_data}[week_trade_day]
    Close Mobile Application    sittc60028_ess_verify_approved
    ...
    [Teardown]    Teardown Test Case    sittc60028_ess_verify_swap_approved
