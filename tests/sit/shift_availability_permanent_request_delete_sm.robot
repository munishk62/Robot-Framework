*** Settings ***
Documentation       SITTC60068 - Requests - Add permanent availability not reviewed and SM deletes from monthly calendar
...
Suite Setup         Clean Up Permanent Availability Request    ESS9_STORE11    SM1_STORE11    2_0
Suite Teardown      Run Keyword And Ignore Error    Close Application

Test Tags           action:write    dev:ashish    sittc60068    config:ess    config:rws    config:add_edit_delete_availability_ess    mobile    sit    sit_b0    sit_v1    sit_r22
...    config:mobile_shift_enabled    config:mobile_sm_enabled


*** Test Cases ***
SITTC60068: Requests - Add permanent availability not reviewed and SM deletes from monthly calendar
    [Documentation]    Requests - Add permanent availability not reviewed and SM deletes from monthly calendar
    ${add_availability}    Get Shift Availability Data    template_name=add_availability_#1    start_date=2_0
    Open Mobile ESS App    sittc60068
    ...
    Close Mobile Application    sittc60068_ess9_add_permanent_availability_request

    Open SM Native Application On Mobile Phone    sittc60068
    ...
    [Teardown]    Teardown Test Case    sittc60068
