...
Suite Setup         Run Only Once    Pre Setup Schedule For Week 1 SM1 Store9 SIT
Test Teardown       Close Browser


*** Test Cases ***
SITTC80007 : Verify VDI Based Workload Regeneration Using Regenerate Unedited Schedules Option When Schedule Is Not Edited And Unpublished
    [Documentation]    SITTC80007: Workload is generated for the store ZSITSTORE009 for VDI based activity (1FTE from 10a to 6p for day 2 to Day 6) for PW#1
    ...    Optimized schedule is generated for the store ZSITSTORE009 for PW#1. No edits are present in the schedule
    ...
    ...
    ...    - Weekplan Status: Workload Generated, Schedule Generated, Unedited and Unpublished
    ...
    ...    **Test Flow:**
    ...    1. Verify pre-state: Days 2-6 have 10a-6p shifts, Days 1 & 7 have no shifts
    ...    2. Logout, login as CORP, perform VDI import with 2p-10p for Days 1,3,4,5,7 (skip 2,6) with "Delete and Generate unedited schedules"
    ...
    ...    5. Verify Review Schedule Changes report shows deletion and regeneration
    ...    6. Teardown: Delete schedule and workload for PW#1
    ...
    ...    **KEY TEST POINT:** Uses "Delete and Generate unedited schedules" option. Since schedule is unedited, it gets regenerated.
    [Tags]    dev:azar    rws    sittc80007    sit_v3    sit_bp    sit    web    sit_r22_epic    schedule_dependent
