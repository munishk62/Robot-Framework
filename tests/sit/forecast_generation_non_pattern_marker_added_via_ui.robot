*** Settings ***
Documentation       Suite verifies validate the forecast generation for recurring non-pattern based markers added from the UI.
...
Test Tags           dev:amol    action:write    sittc76101    config:rws    sit    sit_v4    module:forecast    sit_r22    web    sit_epic


*** Test Cases ***
SITTC76101: Verify forecast generation for recurring non-pattern based marker added from UI
    [Documentation]
    ...
    ${sm_user}    Get User    user_key=SM1_STORE1_SIT
