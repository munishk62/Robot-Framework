*** Settings ***
Documentation       BATTC00179 - Verify ESS user is able to edit day off requests in mobility
...
Test Tags    dev:kishan    battc00179    config:ess    config:holiday_hours_disabled    config:ess_add_edit_delete_dayoff    bat_phase2
...    mobile
...    config:mobile_shift_enabled


*** Test Cases ***
BATTC00179: Verify ESS user is able to edit day off requests in mobility without holiday hours
    ...
    Open Mobile ESS App    battc00179
    ...
    [Teardown]    Teardown Test Case    battc00179
