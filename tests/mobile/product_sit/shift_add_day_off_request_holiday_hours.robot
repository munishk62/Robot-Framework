*** Settings ***
Documentation       BATTC00178 - Verify ESS user is able to add day off requests in mobility with holiday hours
...
Test Tags    dev:bushra    battc00178    config:ess    bat_phase2    config:holiday_hours_enabled    config:ess_add_edit_delete_dayoff
...    mobile
...    config:mobile_shift_enabled


*** Test Cases ***
BATTC00178: Verify ESS user is able to add day off requests in mobility with holiday hours
    ...
    ...    holiday_hours={"4":"8"}    reason=${day_off_reason}
    ...
    Open Mobile ESS App    battc00178
    ...
    [Teardown]    Teardown Test Case    battc00178
